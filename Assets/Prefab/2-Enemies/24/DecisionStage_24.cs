...
public class DecisionStage_24 : EnemyState
{
    public DecisionStage_24(EnemyBrain brain) : base(brain) { }
    ...
    {
        base.Enter();
        Debug.Log("DecisionStage_24: Entering decision stage");
    ...
    public override void Update()
    {
        ...
        if (brain.EnemyVision.CanSeePlayer)
        {
            ...
            if (stateTimer >= stateDuration)
            {
                ...
                brain.ChangeState(new ArcAround_24(brain));
            }
        }
    }
    ...
    {
        base.Exit();
        Debug.Log("DecisionStage_24: Exiting decision stage");
    }
}
